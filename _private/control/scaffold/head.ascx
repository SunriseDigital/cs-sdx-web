...
<script type="text/javascript" src="<%=Sdx.Util.Path.AutoMin("https://code.jquery.com/jquery-2.2.0.min.js") %>"></script>
<script type="text/javascript" src="<%=Sdx.Util.Path.AutoMin("/lib/js/scaffold.min.js") %>"></script>
